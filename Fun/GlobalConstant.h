...
#define EXPLORE_BLOCK_ELEMENT_DIM_X 250
#define EXPLORE_BLOCK_ELEMENT_DIM_Y 250
#define EXPLORE_BLOCK_ELEMENT_DIM_WIDTH 15
#define EXPLORE_BLOCK_ELEMENT_DIM_HEIGHT 15
